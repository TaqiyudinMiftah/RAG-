...
def load_documents(directory_path: str):
    ...
    # loader_cls=TextLoader digunakan untuk memastikan file dibaca sebagai teks biasa
    ...
    # print(documents[0].page_content[:200] + "...") # Menampilkan pratinjau singkat
    # print("----------------------")
...
def split_documents(documents: list, chunk_size: int = 800, chunk_overlap: int = 0):
    ...
    text_splitter = CharacterTextSplitter(
        ...
        separator="\n\n", # Mencoba memecah berdasarkan paragraf terlebih dahulu
